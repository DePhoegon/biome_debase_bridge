...
public class SmoothSandstoneFences {
    ...
    public static final RegistryObject<FenceBlock> WHITE_SMOOTH_SANDSTONE_FENCE = register("white_smooth_sandstone_fence",
            () -> new FenceSandstones(BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_WHITE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<FenceBlock> ORANGE_SMOOTH_SANDSTONE_FENCE = register("orange_smooth_sandstone_fence",
            () -> new FenceSandstones(BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_ORANGE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<FenceBlock> BLACK_SMOOTH_SANDSTONE_FENCE = register("black_smooth_sandstone_fence",
            () -> new FenceSandstones(BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_BLACK_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
