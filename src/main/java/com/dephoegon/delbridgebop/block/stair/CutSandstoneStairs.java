...
public class CutSandstoneStairs {
    ...
    public static final RegistryObject<StairBlock> WHITE_CUT_SANDSTONE_STAIR = register("white_cut_sandstone_stair",
            () -> new StairSands(BOPBlocks.CUT_WHITE_SANDSTONE::defaultBlockState, BlockBehaviour.Properties.copy(BOPBlocks.CUT_WHITE_SANDSTONE).sound(SoundType.STONE),"","",""));
    public static final RegistryObject<StairBlock> ORANGE_CUT_SANDSTONE_STAIR = register("orange_cut_sandstone_stair",
            () -> new StairSands(BOPBlocks.CUT_ORANGE_SANDSTONE::defaultBlockState, BlockBehaviour.Properties.copy(BOPBlocks.CUT_ORANGE_SANDSTONE).sound(SoundType.STONE),"","",""));
    public static final RegistryObject<StairBlock> BLACK_CUT_SANDSTONE_STAIR = register("black_cut_sandstone_stair",
            () -> new StairSands(BOPBlocks.CUT_BLACK_SANDSTONE::defaultBlockState, BlockBehaviour.Properties.copy(BOPBlocks.CUT_BLACK_SANDSTONE).sound(SoundType.STONE),"","",""));
