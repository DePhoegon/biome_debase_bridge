...
public class StrippedWoodStairs {
    ...
    public static final RegistryObject<StairBlock> STRIPPED_FIR_WOOD_STAIR = register("stripped_fir_wood_stair",
            () -> new StairWoods(FIR_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(FIR_WOOD).sound(SoundType.WOOD),"","","",true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_REDWOOD_WOOD_STAIR = register("stripped_redwood_wood_stair",
            () -> new StairWoods(REDWOOD_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(REDWOOD_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_CHERRY_WOOD_STAIR = register("stripped_cherry_wood_stair",
            () -> new StairWoods(CHERRY_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(CHERRY_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_MAHOGANY_WOOD_STAIR = register("stripped_mahogany_wood_stair",
            () -> new StairWoods(MAHOGANY_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(MAHOGANY_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_JACARANDA_WOOD_STAIR = register("stripped_jacaranda_wood_stair",
            () -> new StairWoods(JACARANDA_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(JACARANDA_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_PALM_WOOD_STAIR = register("stripped_palm_wood_stair",
            () -> new StairWoods(PALM_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(PALM_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_WILLOW_WOOD_STAIR = register("stripped_willow_wood_stair",
            () -> new StairWoods(WILLOW_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(WILLOW_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_DEAD_WOOD_STAIR = register("stripped_dead_wood_stair",
            () -> new StairWoods(DEAD_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(DEAD_WOOD).sound(SoundType.WOOD),"","","", false, null));
    public static final RegistryObject<StairBlock> STRIPPED_MAGIC_WOOD_STAIR = register("stripped_magic_wood_stair",
            () -> new StairWoods(MAGIC_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(MAGIC_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_UMBRAN_WOOD_STAIR = register("stripped_umbran_wood_stair",
            () -> new StairWoods(UMBRAN_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(UMBRAN_WOOD).sound(SoundType.WOOD),"","","", true, null), 5001);
    public static final RegistryObject<StairBlock> STRIPPED_HELLBARK_WOOD_STAIR = register("stripped_hellbark_wood_stair",
            () -> new StairWoods(HELLBARK_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(HELLBARK_WOOD).sound(SoundType.WOOD),"","","", false, null));
