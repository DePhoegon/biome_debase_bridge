...
public class EnergySandstoneSlabs {
    ...
    public static final RegistryObject<SlabBlock> WHITE_ENERGY_CHISELED_SANDSTONE_SLAB = register("white_energy_chiseled_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.CHISELED_WHITE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> ORANGE_ENERGY_CHISELED_SANDSTONE_SLAB = register("orange_energy_chiseled_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.CHISELED_ORANGE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> BLACK_ENERGY_CHISELED_SANDSTONE_SLAB = register("black_energy_chiseled_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.CHISELED_BLACK_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> WHITE_ENERGY_CUT_SANDSTONE_SLAB = register("white_energy_cut_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.CUT_WHITE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> ORANGE_ENERGY_CUT_SANDSTONE_SLAB = register("orange_energy_cut_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.CUT_ORANGE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> BLACK_ENERGY_CUT_SANDSTONE_SLAB = register("black_energy_cut_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.CUT_BLACK_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> WHITE_ENERGY_SMOOTH_SANDSTONE_SLAB = register("white_energy_smooth_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_WHITE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> ORANGE_ENERGY_SMOOTH_SANDSTONE_SLAB = register("orange_energy_smooth_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_ORANGE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> BLACK_ENERGY_SMOOTH_SANDSTONE_SLAB = register("black_energy_smooth_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_BLACK_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> WHITE_ENERGY_SANDSTONE_SLAB = register("white_energy_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.WHITE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> ORANGE_ENERGY_SANDSTONE_SLAB = register("orange_energy_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.ORANGE_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
    public static final RegistryObject<SlabBlock> BLACK_ENERGY_SANDSTONE_SLAB = register("black_energy_sandstone_slab",
            () -> new SlabSandstones(BlockBehaviour.Properties.copy(BOPBlocks.BLACK_SANDSTONE).sound(SoundType.STONE),"tooltip.delbridgebop.bop","",""));
