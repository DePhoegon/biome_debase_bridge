...
public class FenceGateSandstones extends fenceGateBlock {
    public FenceGateSandstones(Properties properties, String normToolTip, String shiftToolTip, String ctrlToolTip) {
